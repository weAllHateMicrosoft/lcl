...
export function tutorSystem(ctx: { lessonTitle: string; goal: string; exercisePrompt?: string; record?: string }): string {
...
export function generateSystem(ctx: { lessonTitle: string; goal: string; record?: string }): string {
